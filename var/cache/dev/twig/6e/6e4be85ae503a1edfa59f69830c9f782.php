    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        yield "</td>
                        ...
                        <tr>
                            ...
                            <td>";
        // line 32
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 32, $this->source); })()), "image", [], "any", false, false, false, 32), "html", null, true);
        yield "</td>
                        </tr>
                        <tr>
                            <th>Datemsg</th>
                            <td>";
        // line 36
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 36, $this->source); })()), "datemsg", [], "any", false, false, false, 36)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 36, $this->source); })()), "datemsg", [], "any", false, false, false, 36), "Y-m-d H:i:s"), "html", null, true)) : (""));
        yield "</td>
                        </tr>
                    </tbody>
                </table>
...
";
    ...
    {
        return array (  160 => 43,  156 => 42,  147 => 36,  140 => 32,  133 => 28,  126 => 24,  119 => 20,  112 => 16,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}", "message/show.html.twig", "C:\\xampp\\htdocs\\RAHMA\\esprit\\templates\\message\\show.html.twig");
    }
}
