...
class __TwigTemplate_f5ca671cec2e4e96343aba8ec34fbe5a extends Template
{
...
<a href=\"";
        // line 145
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_message_show2", ["id" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["reply"]) || array_key_exists("reply", $context) ? $context["reply"] : (function () { throw new RuntimeError('Variable "reply" does not exist.', 145, $this->source); })()), "message", [], "any", false, false, false, 145), "id", [], "any", false, false, false, 145)]), "html", null, true);
...
";
    ...
    {
        return array (  290 => 147,  285 => 145,  279 => 142,  276 => 141,  271 => 138,  262 => 136,  258 => 135,  254 => 133,  252 => 132,  243 => 125,  230 => 124,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
            ...
            <div class=\"row\">
                <div class=\"col-sm-12\">
                    <div class=\"form-container\">
                        ...
                        <div class=\"actions\">
<a href=\"{{ path('app_message_show2', {'id': reply.message.id}) }}\" class=\"back-btn\">Retourner</a>
...
{% endblock %}
", "reply/edit.html.twig", "C:\\xampp\\htdocs\\RAHMA\\esprit\\templates\\reply\\edit.html.twig");
    }
}
