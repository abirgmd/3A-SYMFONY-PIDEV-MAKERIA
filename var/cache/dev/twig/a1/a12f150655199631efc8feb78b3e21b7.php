...
\t\t\t\t\t\t\t\t";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 326, $this->source); })()), "user", [], "any", false, false, false, 326)) {
                // line 327
                yield "<img src=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("user/" . CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 327, $this->source); })()), "user", [], "any", false, false, false, 327), "image", [], "any", false, false, false, 327))), "html", null, true);
...
\t  <li class=\"nav-link\">
        <a href=\"user/";
            // line 343
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 343, $this->source); })()), "user", [], "any", false, false, false, 343), "id", [], "any", false, false, false, 343), "html", null, true);
...
\t";
            ...
            // line 585
            yield from $this->loadTemplate("exception/index.html.twig", "dashboard.html.twig", 585)->unwrap()->yield($context);
        }
...
\t\t\t";
    ...
    {
        return array (  840 => 580,  818 => 362,  796 => 25,  772 => 11,  760 => 585,  754 => 581,  752 => 580,  613 => 444,  609 => 443,  605 => 442,  600 => 440,  593 => 436,  589 => 435,  585 => 434,  581 => 433,  509 => 363,  507 => 362,  485 => 343,  469 => 329,  463 => 327,  461 => 326,  412 => 279,  397 => 268,  388 => 262,  379 => 256,  365 => 244,  352 => 234,  343 => 228,  323 => 211,  314 => 205,  294 => 188,  285 => 182,  276 => 176,  256 => 159,  247 => 153,  238 => 147,  218 => 130,  209 => 124,  189 => 107,  182 => 103,  175 => 99,  160 => 86,  158 => 85,  97 => 26,  93 => 25,  88 => 23,  82 => 20,  73 => 13,  71 => 11,  66 => 9,  62 => 8,  54 => 2,  52 => 1,);
    }
        ...
        <li>
            ...
            <ul class=\"sub-menu\" id=\"settings-submenu\">
                <li>
                 ...
                 <li>
                    <a href=\"{{ path('app_order_informations_index') }}\">
                        <i class=\"tim-icons icon-star\"></i>
                        <p>Ordersiformations</p>
                    </a>
                </li>
...
{% endif %}
", "dashboard.html.twig", "C:\\Users\\hp\\Downloads\\wetransfer_esprit-zip_2025-03-03_1218\\esprit\\esprit\\templates\\dashboard.html.twig");
    }
}
