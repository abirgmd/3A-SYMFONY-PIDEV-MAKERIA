...
class __TwigTemplate_78e57c005811ce839fa781f09af0f401 extends Template
{
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            ...
            yield "</strong>
                        ...
                        ";
            // line 20
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["field"], 'widget', ["attr" => ["class" => ("form-control" . (((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,             // line 21
$context["field"], "vars", [], "any", false, false, false, 21), "errors", [], "any", false, false, false, 21)) > 0)) ? (" is-invalid") : ("")))]]);
            // line 22
            yield "
...
";
    ...
    {
        return array (  178 => 40,  171 => 36,  166 => 33,  159 => 31,  155 => 29,  146 => 27,  142 => 26,  139 => 25,  137 => 24,  133 => 22,  131 => 21,  130 => 20,  124 => 17,  120 => 16,  117 => 15,  113 => 14,  107 => 11,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
            ...
            <div class=\"form-container\">
                {% for field in form %}
                    <div class=\"form-group\">
                        ...
                        {{ form_widget(field, {
                            'attr': {'class': 'form-control' ~ (field.vars.errors|length > 0 ? ' is-invalid' : '')}
                        }) }}
                ...
                <div class=\"form-actions mt-4\">
                    <button type=\"submit\" class=\"btn btn-primary\">Créer</button>
                    <a href=\"{{ path('app_reponses_index') }}\" class=\"btn btn-secondary\">Retour à la liste</a>
                </div>
            </div>
...
{% endblock %}
", "reponses/new.html.twig", "C:\\xampp\\htdocs\\RAHMA\\esprit\\templates\\reponses\\new.html.twig");
    }
}
