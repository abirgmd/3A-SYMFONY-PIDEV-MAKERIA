...
class __TwigTemplate_89e6856a688820563da754472527ffdd extends Template
{
...
<p>
Pour réinitialiser votre mot de passe, veuillez visiter le lien suivant</p>

<a href=\"";
        // line 6
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_reset_password", ["token" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 6, $this->source); })()), "token", [], "any", false, false, false, 6)]), "html", null, true);
        yield "\">";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_reset_password", ["token" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 6, $this->source); })()), "token", [], "any", false, false, false, 6)]), "html", null, true);
        yield "</a>
...
<p>Ce lien expirera dans
 ...
 ", "reset_password/email.html.twig", "C:\\xampp\\htdocs\\RAHMA\\esprit\\templates\\reset_password\\email.html.twig");
    }
}
