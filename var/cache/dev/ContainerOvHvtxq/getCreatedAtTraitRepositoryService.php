 ...
 */
class getCreatedAtTraitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CreatedAtTraitRepository' shared autowired service.
     *
     * @return \App\Repository\CreatedAtTraitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CreatedAtTraitRepository.php';

        return $container->privates['App\\Repository\\CreatedAtTraitRepository'] = new \App\Repository\CreatedAtTraitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
