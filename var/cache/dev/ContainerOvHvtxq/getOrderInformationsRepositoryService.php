 ...
 */
class getOrderInformationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OrderInformationsRepository' shared autowired service.
     *
     * @return \App\Repository\OrderInformationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OrderInformationsRepository.php';

        return $container->privates['App\\Repository\\OrderInformationsRepository'] = new \App\Repository\OrderInformationsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
